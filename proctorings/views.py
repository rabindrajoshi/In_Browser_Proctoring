                    ...
                    if direct_photo_url:
                        ...
                        if not default_storage.exists(photo_file_path):
                            ...
                            photo_path = default_storage.save(
                                photo_file_path, ContentFile(photo_response.content)
                            )
                        else:
                ...
                if cv_url:
                    ...
                    if direct_cv_url:
                        ...
                        if not default_storage.exists(cv_file_path):
                            ...
                            cv_path = default_storage.save(
                                cv_file_path, ContentFile(cv_response.content)
                            )
                        else:
...
def create_user_from_form_response(row):
    ...
    )  # Handles cases where there may not be a last name
    print(full_name)
